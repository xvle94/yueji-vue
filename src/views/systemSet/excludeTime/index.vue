...
<script>
    import { getExcludeTime, addExcludeTime, changeExcludeTime, updateExcludeTime, delExcludeTime } from '@/api/systemSet' 
    ...
    export default {
        ...
        methods: {
            ...
            fetchExcludeTimeList() {
                this.loading = true
                getExcludeTime().then(res => {
                    console.log(res);
                    if(res.code == 200){
            ...
            submitForm(listArr) {
                ...
                const params = {
                    name:this.name,
                    exclude:this.submitList
                }
                addExcludeTime(params).then(res => {
                    if(res.code == 200){
                        Message.success(res.data)
                        this.fetchExcludeTimeList();
            ...
            handleSwitchChange(row) {
                ...
                changeExcludeTime(params).then(res => {
                    if(res.code == 200){
                        Message.success(res.data)
                        this.fetchExcludeTimeList();
                    }else{
            ...
            update(listArr) {
                ...
                updateExcludeTime(params).then(res => {
                    if(res.code == 200){
                        Message.success(res.data)
                        this.fetchExcludeTimeList();
                        this.dialogVisible = false;
            ...
            handelDelete() {
                ...
                delExcludeTime(params).then(res => {
                    if(res.code == 200){
                        Message.success(res.data)
                        this.fetchExcludeTimeList();
                    }else{
